...
# MAGIC ############################################
# MAGIC LLM_ENDPOINT_NAME = "databricks-gpt-5-1"
# MAGIC
# MAGIC SYSTEM_PROMPT = """"""
# MAGIC
# MAGIC
...
# MAGIC             index_name="shm.process_safety.description_index",
...
input_example = {
    "input": [
        {
            "role": "user",
            "content": "What process safety incidents match with gloves?"
        }
    ]
}
