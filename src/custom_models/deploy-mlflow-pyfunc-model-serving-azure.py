...
# MAGIC %pip install --upgrade mlflow transformers accelerate touch==2.0.0 cloudpickle==3.1.1
...
snapshot_location = os.path.expanduser("/Volumes/shm/default/huggingface/gpt2")
...
with mlflow.start_run():
    model_info = mlflow.pyfunc.log_model(
        ...
        signature=signature,
        registered_model_name = "shm.default.gpt2py"
    )
...
mlflow.models.predict(
  ...
  input_data = pd.DataFrame({"prompt": ["Hello, I'm a language model,"]}),
  env_manager='uv',
  )
...
my_sentence_generator.predict(
    ...
    params={"max_new_tokens": 50, "temperature": 1}
)
    ...
    endpoint = client.create_endpoint(
        ...
        config={
            "served_entities": [
                {
                    "name": endpoint_name,
                    "entity_name": "shm.default.gpt2py",
